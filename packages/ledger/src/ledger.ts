...
export default class CSC {
   ...
   * @param ed25519 optionally enable or not the ed25519 curve
   * (secp256k1 is default)
   ...
   * @example
   * const signature = await csc.signTransaction("44'/144'/0'/0/0",
   * "12000022800000002400000002614000000001315D3468400000000000000
   * C73210324E5F600B52BB3D9246D49C4AB1722BA7F32B7A3E4F9F2B8A1A28B9
   * 118CC36C48114F31B152151B6F42C1D61FE4139D34B424C8647D183142ECF
   * C1831F6E979C6DA907E88B1CAD602DB59E2F");
   */
